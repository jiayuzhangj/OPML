...
class max_textencode(nn.Module):  
    ...
    def forward(self,x,text1,text2,text3,text4):
        ...
        return text_features1,text_features2,text_features3,text_features4,image_features,text_feature

class DME(nn.Module):
    def __init__(self, in_planes, out_planes, kernel_size=1,ratio=16):
...
class OPML_model(nn.Module):
    def __init__(self, longclip_path,num_classes=1):
        super(OPML_model, self).__init__()
        ...
        self.DME_4 = DME(2048,2048)
        self.DME_3 = DME(1024,1024)
        self.DME_2 = DME(512,512)
        self.DME_1 = DME(256,256)
